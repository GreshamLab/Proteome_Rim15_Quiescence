---
title: "03 — ANCOVA (RETIRED)"
output: html_notebook
---

**Status: RETIRED.** This script crashes at the ANCOVA modeling step and is
superseded by `04_protein_de_go_analysis.Rmd`, which produces the ANCOVA
results used in the paper. Do not run.
